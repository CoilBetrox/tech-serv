    ...
    <main class="flex flex-1 flex-col items-center py-12 px-4 sm:px-10 lg:px-40">
      <div class="max-w-[900px] w-full">
        ...
        <div class="space-y-6">
          ...
          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Restricciones</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Usted acepta no:
            </p>
            <ul class="mt-3 list-disc list-inside text-sm text-slate-500 dark:text-slate-400">
                <li>Licenciar, vender, alquilar, arrendar o explotar comercialmente la plataforma a terceros.</li>
                <li>Modificar, realizar ingeniería inversa o descompilar cualquier parte del software.</li>
                <li>Utilizar la plataforma para almacenar material ilícito o malicioso.</li>
            </ul>
          </section>

          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Política de Devolución y Reembolso</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Debido a la naturaleza del software como servicio (SaaS) y la oferta de periodos de prueba gratuitos (si aplica), no se realizarán reembolsos por periodos ya pagados. En caso de pagos por instalación inicial, una vez realizado el despliegue técnico, dicho monto no será reembolsable.
            </p>
          </section>

          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Cancelación</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Usted puede cancelar su suscripción o el uso del servicio en cualquier momento. La cancelación implica que el acceso a la gestión de tickets será deshabilitado al finalizar el periodo pagado. Es responsabilidad del usuario exportar su información antes de la fecha de corte.
            </p>
          </section>
          ...
          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Tu Consentimiento</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Al utilizar nuestra plataforma, usted acepta nuestra Política de Privacidad y el procesamiento de los datos necesarios (nombres, teléfonos, estados de dispositivos) para la correcta operación del sistema de tickets.
            </p>
          </section>

          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Modificaciones a Nuestro Sitio Web</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Nos reservamos el derecho de modificar, suspender o interrumpir, temporal o permanentemente, el sitio web o cualquier servicio con o sin previo aviso y sin responsabilidad ante usted.
            </p>
          </section>
          ...
          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white">Divisibilidad</h2>
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Si alguna disposición de estos Términos se considera inaplicable o inválida, dicha disposición se cambiará para lograr los objetivos de la misma de la manera más cercana posible bajo la ley aplicable, y las disposiciones restantes permanecerán en pleno vigor.
            </p>
          </section>
          ...
          <section class="bg-white dark:bg-slate-900 rounded-xl border border-[#e7ecf3] dark:border-slate-800 p-6">
            ...
            <p class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                Para cualquier duda o soporte técnico respecto a estos términos, puede comunicarse con nosotros:
            </p>
            <ul class="mt-3 text-sm text-slate-500 dark:text-slate-400">
                <li>
                    <span class="font-medium text-slate-800 dark:text-white">Correo:</span>
                    roberthdanielt@gmail.com
                </li>
                <li>
                    <span class="font-medium text-slate-800 dark:text-white">Teléfono/WhatsApp:</span>
                    +593 99 801 0276
                </li>
            </ul>
