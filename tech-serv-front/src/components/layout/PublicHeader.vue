<template>
  <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7ecf3] dark:border-b-slate-800 px-6 lg:px-40 py-3 bg-white dark:bg-slate-900">
    <div class="flex items-center gap-4">
      ...
      <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]">TechService Pro</h2>
    </div>
